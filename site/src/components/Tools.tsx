...
const tools = [
  ...
  { name: 'create_major / create_iteration / add_task / add_tasks', kind: 'Mutate', desc: 'Grow the plan surgically; add_tasks appends many lines in one write.' },
  { name: 'complete_task / reopen_task / remove_task / defer_task', kind: 'Mutate', desc: 'One or many in one write (indexes after get_iteration); optional [agent: id].' },
